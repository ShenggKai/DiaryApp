...
namespace DiaryApp.Source
{
    public partial class EditContent : Form
    {
        ...
        {
            DiaryItem.instance.Pic = pInsertimage.Image;
            DiaryItem.instance.Title = txtTitle.Text;
            DiaryItem.instance.Content = rtEditConent.Text;
        }
        ...
        {
            pInsertimage.Image = DiaryItem.instance.Pic;
            txtTitle.Text = DiaryItem.instance.Title;
            rtEditConent.Text = DiaryItem.instance.Content;
        }

        private void pInsertimage_Click_1(object sender, EventArgs e)
        {
            OpenFileDialog ofd = new OpenFileDialog();
            ofd.Filter = "Image Files (*.bmp;*.jpg;*.jpeg,*.png)|*.BMP;*.JPG;*.JPEG;*.PNG";
            if (ofd.ShowDialog() == DialogResult.OK)
